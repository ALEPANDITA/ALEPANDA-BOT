  ...
  execute: async (sock, jid, msg) => {
    ...
    if (restante > 0) {
      ...
      return sock.sendMessage(jid, {
        text: advertencia(`Ya trabajaste. Espera ${minutos} minuto(s) para volver a trabajar.`, { titulo: 'ESPERA UN POCO' })
      });
    }
    ...
    await sock.sendMessage(jid, {
      text: exito(`Hoy ${trabajo} y ganaste *$${ganancia}*.\nSaldo actual: *$${usuario.saldo}*`, { titulo: 'TRABAJO COMPLETADO' })
    });
  }
};
