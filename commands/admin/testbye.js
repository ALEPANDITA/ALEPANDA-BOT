...
module.exports = {
  name: 'testbye',
  category: 'admin',
  description: 'Simula un mensaje de despedida con tus propios datos, para ver como se ve sin que nadie tenga que salir de verdad.',
  groupOnly: true,
  execute: async (sock, jid, msg) => {
    ...
    console.log(
      `[testbye] metadata grupo: ${tMetadata - inicio}ms | ` +
