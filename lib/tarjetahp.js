...
async function generarTarjetaConFoto(personaje, rutaImagen) {
  ...
  imagen.print(fuenteTexto, 20, yBase + 55,
    { text: `Casa: ${personaje.casa}  |  ${personaje.rareza.toUpperCase()}`, alignmentX: Jimp.HORIZONTAL_ALIGN_CENTER }, ancho - 40);
...
async function generarTarjetaSinFoto(personaje) {
  ...
  imagen.print(fuenteSub, 0, 340,
    { text: `Casa: ${personaje.casa}`, alignmentX: Jimp.HORIZONTAL_ALIGN_CENTER }, ancho);
